...
<head>
    ...
    <title>تعمیرات کولرگازی جنرال الکتریک | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <br><br>
        ...
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRICE.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRICE 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
