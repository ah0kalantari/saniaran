...
<body class="styles-of-body-tag" onscroll="hide_menu_desktop()">
    ...
    <div  class="first-logo-styles">
        ...
        <img id="first-logo" class="display-inline styles-of-first-logo-in-all-pages-1" src="img/firstlogo/لوگوی سانیاران سرویس.png"             alt="saniaran service سانیاران سرویس">
    ...
    <table>
        <tr class="style-of-mak-img-tr">
            ...
            <td class="style-of-mak-img-tag">
                ...
                <p class="style-of-mak-img-text">در صورت نیاز به نصب یا سرویس و یا تعمیر در اولین فرصت با سانیاران سرویس بصورت آنلاین یا تلفنی ارتباط برقرار نمایید</p>
            </td>
        </tr>
        <tr>
            <td>
...
<tr class="dssdchidshfiueswd2">
    <td class="dssdchidshfiueswd">
        <br>
        <img class="jsdfujsedfewsfgerdgredsgiut" src="img/mak/3.png" alt="سانیاران سرویس">
        <p class="style-of-mak-p-in-mo">در صورت نیاز به نصب یا سرویس و یا تعمیر در اولین فرصت با سانیاران سرویس بصورت آنلاین یا تلفنی ارتباط برقرار نمایید</p>
        <hr class="style-of-mak-hr-in-mo">
    </td>
</tr>
<tr class="dssdchidshfiueswd">
...
<tr class="dssdchidshfiueswd2">
    <td class="dssdchidshfiueswd">
        <br>
        <img class="jsdfujsedfewsfgerdgredsgiut" src="img/mak/1.png" alt="سانیاران سرویس">
